                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control{{ $errors->has('nick') ? ' is-invalid' : '' }}" name="nick" value="{{-- old('nick') --}}{{ $user->nick }}" required autofocus>
                        ...
                        {{-- BLOQUE DE CONTRASEÑA :: CONFIRMAR CONTRASEÑA --}}
                        {{--
                        <div class="form-group row">
